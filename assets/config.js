...
(()=>{
 const version='7';
 ['v2-0.css','v2-1.css','v2-2a.css','v2-2b1.css','v2-2b2.css','v2-3a.css','v2-3b.css','v2-4b.css','v2-4c.css','v2-4d1.css','contacts-v2.css','mobile-v2.css','v2-visible.css'].forEach(file=>{const link=document.createElement('link');link.rel='stylesheet';link.href=`assets/${file}?v=${version}`;document.head.append(link)});
